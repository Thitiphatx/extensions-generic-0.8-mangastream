...
var _Sources = (() => {
  ...
  // src/Makimaaaaa/Makimaaaaa.ts
  var Makimaaaaa_exports = {};
  __export(Makimaaaaa_exports, {
    Makimaaaaa: () => Makimaaaaa,
    MakimaaaaaInfo: () => MakimaaaaaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/Makimaaaaa/Makimaaaaa.ts
  var DOMAIN = "https://makimaaaaa.com";
  var MakimaaaaaInfo = {
  ...
  var Makimaaaaa = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.directoryPath = "manga";
    ...
    configureSections() {
      ...
      this.homescreen_sections["latest_update"].selectorFunc = ($2) => $2("div.bsx", $2("h2:contains(\u0E2D\u0E31\u0E1E\u0E40\u0E14\u0E17\u0E25\u0E48\u0E32\u0E2A\u0E38\u0E14)")?.parent()?.next());
      this.homescreen_sections["latest_update"].subtitleSelectorFunc = ($2, element) => $2("div.epxs", element).first().text().trim();
    }
  };
  return __toCommonJS(Makimaaaaa_exports);
})();
