...
var _Sources = (() => {
  ...
  // src/Manga168/Manga168.ts
  var Manga168_exports = {};
  __export(Manga168_exports, {
    Manga168: () => Manga168,
    Manga168Info: () => Manga168Info
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var Manga168 = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    ...
    configureSections() {
      ...
      this.homescreen_sections["latest_update"].selectorFunc = ($2) => $2("div.uta > div.imgu", $2("h2:contains(\u0E2D\u0E31\u0E1E\u0E40\u0E14\u0E17\u0E25\u0E48\u0E32\u0E2A\u0E38\u0E14)")?.parent()?.next());
      this.homescreen_sections["latest_update"].subtitleSelectorFunc = ($2, element) => $2("ul > li:nth-child(1) > a", $2(element).parent()).text().trim();
    }
  };
  return __toCommonJS(Manga168_exports);
})();
